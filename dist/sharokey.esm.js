/**
 * Sharokey JavaScript SDK - ES Module Version
...
function checkCryptoSupport() {
    ...
    if (!crypto || !crypto.subtle) {
        throw new Error('Web Crypto API not supported. Please use a modern browser or Node.js 16+.');
    }
    return crypto;
}
...
async function makeRequest(method, endpoint, data = null) {
    ...
    try {
        ...
        // Dynamic import for Node.js fetch support
...
function validateAttachments(attachments) {
    ...
    for (const file of attachments) {
        if (!(file instanceof File) && !file.arrayBuffer) {
            throw new Error('Each attachment must be a File object or have arrayBuffer method');
        }
